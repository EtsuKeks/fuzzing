## Фаззинг-тестирование библиотеки jd (подсчет контрольных сумм уже [показывал](https://github.com/EtsuKeks/control_hashes) раньше, тут будет вестись речь только про fuzzing)
